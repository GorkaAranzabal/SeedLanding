...
export default function HeroSectionVideo() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      >
        <source src={seedData.hero.videoPath} type="video/mp4" />
      </video>
      ...
      {/* Subtle Creative Borders (replaced tactical grid) */}
      ...
      {/* Top Header Label */}
      <div className="absolute top-12 w-full flex justify-center items-start pointer-events-none opacity-60 font-space text-xs text-seed-platinum tracking-[0.2em]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-full">
          ...
          >
            ...
            <div className="absolute inset-0 bg-white/5 backdrop-blur-xl border border-white/20 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2)] transition-all duration-300 group-hover:bg-white/10 group-hover:shadow-[0_0_30px_rgba(68,204,68,0.3)]" />
            ...
            {/* Text Content */}
            <span className="relative z-10 font-space font-bold text-lg tracking-[0.2em] text-seed-white group-hover:text-seed-green transition-colors drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
              JOIN WAITLIST
            </span>
      ...
      {/* Footer Status */}
      <div className="absolute bottom-16 w-full px-20 flex justify-between items-end pointer-events-none opacity-60 font-space text-xs text-seed-platinum">
        <div className="flex flex-col gap-1">
          <span className="flex items-center gap-2">
            <span className="w-2 h-2 bg-seed-green rounded-full animate-pulse" />
            WORLD ENGINE: ONLINE
          </span>
          <span>CLOUD REGION: GLOBAL</span>
        </div>
